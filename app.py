...
with tab3:
    ...
    if pend.empty:
        ...
        st.dataframe(pend.drop(columns=["Grupo"], errors="ignore"), use_container_width=True)
        st.warning("Corrija esses itens na aba Lançamentos. Depois, crie uma regra na aba Regras para não acontecer de novo.")
